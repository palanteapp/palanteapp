...
export const PartnerInviteModal: React.FC<PartnerInviteModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fade-in">
            ...
            {/* Modal */}
            <div className={`relative w-full max-w-md max-h-[90vh] overflow-y-auto p-6 rounded-2xl shadow-2xl ${isDarkMode ? 'bg-warm-gray-green border border-white/10' : 'bg-white border border-sage/20'
                }`}>
                {/* Close Button */}
                <button
                    onClick={onClose}
                ...
                <div className="relative mb-6">
                    ...
                    <div className="relative flex justify-center">
                        <span className={`px-3 text-xs uppercase tracking-wider font-bold ${isDarkMode ? 'bg-warm-gray-green text-white/40' : 'bg-white text-sage/40'
                            }`}>
                            Or
                        </span>
                    </div>
