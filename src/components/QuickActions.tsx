        ...
        <div className="w-full mb-6 flex gap-3">
            {showRitual && (
                <button
                    ...
                    className="flex-1 flex items-center justify-between px-4 py-3 rounded-xl bg-gradient-to-r from-pale-gold/20 to-amber-500/20 border border-pale-gold/30 hover:border-pale-gold/50 transition-all hover:scale-[1.02] active:scale-95"
                >
