                    ...
                    <div className="grid grid-cols-2 gap-3">
                        {tracks.map(track => (
                            <button
                                ...
                                className={`tap-zone p-6 rounded-card transition-all duration-300 flex flex-col items-center gap-3 ${currentTrackId === track.id && isPlaying
                                    ? 'bg-sage text-white shadow-spa-lg scale-105'
                                    : 'bg-white/50 border border-sage/20 text-warm-gray-green hover:bg-white hover:shadow-spa'
                                    }`}
                            >
                                ...
                                <span className="text-sm font-body font-medium text-center">{track.name}</span>
                            </button>
                        ))}
                    </div>
                </div>
