...
import { Sparkles, Flame, Target, Sunrise, Moon, Coffee, Zap, Star } from 'lucide-react';
...
export const CoachCard: React.FC<CoachCardProps> = ({
    ...
    return (
        <div
            onClick={onClick}
            className={`w-full ${isCompactMode ? 'p-5' : 'p-7'} rounded-[2.5rem] relative overflow-hidden transition-all duration-700 border ${bgClass} ${onClick ? 'cursor-pointer hover:bg-white/[0.05] active:scale-[0.99]' : ''}`}
        >
