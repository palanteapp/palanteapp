        ...
        <SlideUpModal isOpen={isOpen} onClose={onClose} isDarkMode={isDarkMode}>
            <div className="p-6">
                ...
                <div className={`p-4 rounded-xl mb-6 ${isDarkMode ? 'bg-white/5 border border-white/10' : 'bg-sage/5 border border-sage/10'}`}>
                    <p className={`text-sm ${isDarkMode ? 'text-white/80' : 'text-warm-gray-green/80'}`}>
                ...
                <div className="space-y-4 mb-6">
                    {/* Month */}
                    <div>
                        <label className={`block text-sm font-medium mb-2 ${isDarkMode ? 'text-white' : 'text-warm-gray-green'}`}>
                            Birth Month
                        </label>
                        <select
                            value={birthMonth}
                            ...
                            className={`w-full px-4 py-3 rounded-xl border transition-colors ${isDarkMode
                                    ...
                                    : 'bg-white border-sage/20 text-warm-gray-green focus:border-sage'
                                }`}
                        >
