...
const CEREMONIES: Record<RingCeremonyType, {
    ...
    ring1: {
        ...
        title: 'Ring One',
        subtitle: 'The Roots',
        coachMessage: 'Nine days. Your roots are in the ground. Most people never make it here — but you did. The garden is beginning to wake.',
    ...
    ring2: {
        ...
        title: 'Ring Two',
        subtitle: 'The Bloom Begins',
        coachMessage: '27 days. Something has shifted — you may not be able to name it yet, but your body knows it. This is the feeling of becoming.',
    ...
    ring3: {
        ...
        title: 'Ring Three',
        subtitle: 'Full Canopy',
        coachMessage: '54 days in. What started as intention has become instinct. Most habits are just now forming for others — yours are already roots.',
