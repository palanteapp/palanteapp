                                ...
                                <div className="space-y-3">
                                    {howToUse.steps.map((step, index) => (
                                        <div key={index} className="flex gap-3">
                                            <div className={`flex-shrink-0 w-6 h-6 rounded-full ${accentBg} flex items-center justify-center text-xs font-bold ${isDarkMode ? 'text-warm-gray-green' : 'text-white'}`}>
                                                {index + 1}
                                            </div>
                            ...
                            <div>
                                ...
                                <div className="space-y-2">
                                    {theScience.benefits.map((benefit, index) => (
                                        <div key={index} className={`flex gap-3 p-3 rounded-lg ${isDarkMode ? 'bg-white/5' : 'bg-warm-gray-green/5'}`}>
