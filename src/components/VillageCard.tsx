...
import { Users, UserPlus, Flame, ChevronRight } from 'lucide-react';
...
export const VillageCard: React.FC<VillageCardProps> = ({ isDarkMode, onOpenInvite }) => {
    ...
    return (
        <div className={`w-full p-6 rounded-2xl border relative ${isDarkMode ? 'bg-white/5 border-white/10' : 'bg-white/60 border-sage/20'
            ...
            {/* Toast */}
            {toast && (
                <div className="absolute top-4 left-1/2 -translate-x-1/2 z-20 px-4 py-2 rounded-full bg-black/80 backdrop-blur text-white text-xs font-bold shadow-xl animate-fade-in flex items-center gap-2">
