...
const SortableStepItem = ({
    ...
    step: StackStep;
    index: number;
    handleStepChange: (id: string, field: keyof StackStep, value: any) => void;
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-1 bg-black/5 dark:bg-white/10 px-2 py-1 rounded-md">
...
export const StackEditorModal: React.FC<StackEditorModalProps> = ({
    ...
    const bgClass = isDarkMode ? 'bg-warm-gray-green text-white' : 'bg-ivory text-sage';
    ...
    const handleStepChange = (id: string, field: keyof StackStep, value: any) => {
    ...
    return (
        <div className="fixed inset-0 z-[80] flex items-center justify-center p-6 bg-black/40 backdrop-blur-sm animate-fade-in">
