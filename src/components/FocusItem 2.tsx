    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                className={`group relative flex items-center justify-between p-5 rounded-2xl border transition-all duration-200 ease-out select-none ${bgClass} ${focus.isCompleted ? 'opacity-60' : 'hover:scale-[1.01] hover:shadow-spa'} ${isEditing ? 'border-pale-gold ring-2 ring-pale-gold/20 animate-pulse-subtle' : ''}`}
            >
