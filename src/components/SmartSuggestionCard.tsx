...
const getIcon = (type: string) => {
    switch (type) {
        ...
        case 'priming': return Sun;
        case 'reflect': return Moon;
...
export const SmartSuggestionCard: React.FC<SmartSuggestionCardProps> = ({
    ...
    const Icon = suggestion ? getIcon(suggestion.type) : Sparkles;
                    ...
                    <div className="flex-1 pt-1">
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-widest transition-all ${isDarkMode
                                ? 'bg-pale-gold text-warm-gray-green hover:bg-white hover:scale-105 active:scale-95'
