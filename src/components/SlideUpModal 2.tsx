        ...
        <div className="fixed inset-0 z-[100] overflow-y-auto animate-fade-in font-sans">
            ...
            <div
                className={`absolute inset-0 z-0 transition-all duration-700 ${fullScreen
                    ? (isDarkMode ? 'bg-warm-gray-green/95' : 'bg-white/95') + ' backdrop-blur-xl'
                ...
                <div
                    className={`
                        ...
                        ${fullScreen
                            ...
                            : `sm:max-w-xl sm:rounded-[2.5rem] rounded-t-[3rem] shadow-[0_32px_64px_-12px_rgba(0,0,0,0.5)] border ${fixedHeight ? 'h-[85dvh] sm:h-[90dvh]' : 'max-h-[85dvh] sm:max-h-[80dvh]'} ${position === 'center' || position === 'top' ? 'rounded-b-[3rem]' : ''}`
                        }
                        ${isDarkMode
                            ? 'bg-warm-gray-green/90 border-white/5 backdrop-blur-2xl'
                            : 'bg-white/95 border-sage/5 backdrop-blur-2xl shadow-[0_32px_64px_-12px_rgba(111,123,109,0.3)]'
                        }
                    `}
