...
export const CelebrationModal: React.FC<CelebrationModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fade-in">
            ...
            {/* Modal */}
            <div
                className={`relative max-w-md w-full p-8 rounded-[2.5rem] shadow-spa-lg animate -scale-in transition-all duration-500 ${isDarkMode ? 'bg-warm-gray-green/95 border border-white/10' : 'bg-white/95 border border-sage/20'}`}
                style={{
