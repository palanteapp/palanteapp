...
export const OnboardingChecklist: React.FC<OnboardingChecklistProps> = ({
    ...
    return (
        <div className={`p-4 rounded-2xl border ${isDarkMode ? 'bg-gradient-to-br from-pale-gold/10 to-amber-500/10 border-pale-gold/30' : 'bg-gradient-to-br from-sage/10 to-sage/5 border-sage/30'}`}>
