...
export const WeeklyReportModal: React.FC<WeeklyReportModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 animate-fade-in">
            ...
            {/* Modal */}
            <div
                className="relative z-10 w-full max-w-lg bg-gradient-to-br from-sage-dark to-sage rounded-[2.5rem] max-h-[90vh] overflow-hidden flex flex-col transition-all duration-500"
                style={{
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto px-6 pb-6 space-y-6">
                    ...
                    {report.streakInfo.maintained && (
                        <div className="bg-gradient-to-br from-amber/20 to-amber-500/20 rounded-2xl p-5 border-2 border-pale-gold/40">
