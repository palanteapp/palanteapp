...
import { Play, Pause, X, Info, Lightbulb, Target, HelpCircle, Microscope, Settings, Volume2, Sparkles, Heart } from 'lucide-react';
        ...
        >
            ...
            <div className="relative z-10 flex-1 w-full flex flex-col items-center">
                ...
                <div className="flex flex-col items-center gap-6 w-full max-w-sm px-6">
                    ...
                    <div className="flex p-0.5 bg-black/10 backdrop-blur-xl rounded-full border border-white/5 relative z-50">
            ...
            <SlideUpModal isOpen={showInfo} onClose={() => setShowInfo(false)} isDarkMode={isDarkMode} showCloseButton>
                <div className="px-8 py-10 pb-12">
                    ...
                    <button onClick={() => setShowInfo(false)} className={`w-full mt-12 py-4 rounded-xl font-bold tracking-widest text-sm uppercase transition-all hover:scale-[1.02] active:scale-[0.98] ${isDarkMode ? 'bg-pale-gold text-warm-gray-green shadow-lg shadow-pale-gold/10' : 'bg-sage text-white shadow-lg shadow-sage/20'}`}>Got It!</button>
                </div>
            </SlideUpModal>
