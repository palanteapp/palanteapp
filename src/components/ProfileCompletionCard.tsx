...
import { User, Briefcase, Heart, Target, Calendar, ChevronRight, X } from 'lucide-react';
...
const STORAGE_KEY = 'palante_profile_card_dismissed';
const DISMISS_COUNT_KEY = 'palante_profile_card_dismiss_count';
...
export const ProfileCompletionCard: React.FC<ProfileCompletionCardProps> = ({
    ...
    return (
        <div className={`relative rounded-2xl p-4 mb-6 border backdrop-blur-sm transition-all ${isDarkMode
            ...
            <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                    <h4 className={`text-sm font-medium mb-1 ${isDarkMode ? 'text-white' : 'text-warm-gray-green'
                        }`}>
                        Personalize Your Experience
                    </h4>
                    <p className={`text-xs mb-2 ${isDarkMode ? 'text-white/50' : 'text-warm-gray-green/50'
                        }`}>
