        ...
        <div className={`p-6 rounded-2xl ${cardBg} border border-transparent focus-within:border-sage/30 transition-all group`}>
            <div className="flex items-start justify-between mb-4">
                ...
                <button
                    ...
                    className={`
                        p-3 rounded-full transition-all opacity-100 md:opacity-0 md:group-hover:opacity-100
    ...
    if (isAnalyzing) {
        return (
            <div className="w-full min-h-screen flex flex-col items-center justify-center p-8 text-center animate-fade-in">
                <div className={`w-24 h-24 rounded-full flex items-center justify-center mb-8 ${isDarkMode ? 'bg-pale-gold text-warm-gray-green' : 'bg-sage text-white'}`}>
                    ...
                    {!savedToday ? (
                        ...
                        <div className="flex flex-col items-center w-full gap-6">
                            ...
                            <div className={`w-full max-w-sm p-6 rounded-3xl border flex flex-col items-center gap-4 ${isDarkMode ? 'bg-white/5 border-white/10' : 'bg-sage/5 border-sage/10'}`}>
                                ...
                                >
                                    <div className={`w-12 h-12 rounded-full flex items-center justify-center transition-all group-hover:scale-110 ${isDarkMode ? 'bg-pale-gold text-warm-gray-green' : 'bg-sage text-white'}`}>
