...
export const MorningBriefing: React.FC<MorningBriefingProps> = ({ quote, onComplete, username, lastReflection }) => {
    ...
    return (
        <div className={`fixed inset-0 z-50 flex flex-col items-center justify-center bg-warm-gray-green text-white overflow-y-auto transition-opacity duration-1000 ${isExiting ? 'opacity-0' : 'opacity-100'}`}>
            {/* Background Ambience */}
