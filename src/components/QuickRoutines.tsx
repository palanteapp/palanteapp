...
import { Play, Plus, Zap, ArrowRight, MoreHorizontal, HelpCircle, Microscope, Trash2, Pencil, X } from 'lucide-react';
    ...
    return (
        <div className="mb-8">
            <div className="flex flex-col items-center justify-center mb-6 gap-3">
                <h3 className={`text-lg font-display font-medium ${isDarkMode ? 'text-white' : 'text-warm-gray-green'}`}>
