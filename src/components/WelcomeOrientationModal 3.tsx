...
import { X, Heart, Map, Compass, BookOpen, User, Maximize2, Sun, Zap, Sparkles, TrendingUp } from 'lucide-react';
...
export const WelcomeOrientationModal: React.FC<WelcomeOrientationModalProps> = ({
    ...
    const textSecondary = isDarkMode ? 'text-white/70' : 'text-warm-gray-green/70';
    ...
    const tabInactiveBg = isDarkMode ? 'bg-white/5 border-white/10' : 'bg-warm-gray-green/5 border-warm-gray-green/10';
            ...
            <div className={`flex flex-col h-full ${bgClass} ${textPrimary}`}>
                ...
                <div className="sticky top-0 z-10 backdrop-blur-xl bg-inherit/95 border-b border-white/10 px-6 pt-4 pb-4">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <button
                            onClick={onClose}
                            className={`p-2 rounded-full transition-colors ${isDarkMode ? 'hover:bg-white/10' : 'hover:bg-warm-gray-green/10'}`}
                        >
                    ...
                    {activeTab === 'philosophy' && (
                        <div className="space-y-8 animate-fade-in">
                            ...
                            <div className="space-y-4">
                                <div className={`p-4 rounded-2xl ${isDarkMode ? 'bg-white/5' : 'bg-warm-gray-green/5'}`}>
                                ...
                                <button
                                    ...
                                    className={`text-left w-full p-4 rounded-2xl transition-all hover:scale-[1.02] active:scale-[0.98] ${isDarkMode ? 'bg-white/5 hover:bg-white/10' : 'bg-warm-gray-green/5 hover:bg-warm-gray-green/10'}`}
                                >
                                    <div className="flex gap-4">
                                        <div className={`p-2 rounded-full h-fit ${isDarkMode ? 'bg-pale-gold/10' : 'bg-sage/10'}`}>
                            ...
                            <button
                                ...
                                className={`w-full py-3 rounded-xl font-medium text-sm transition-all border ${isDarkMode
                                    ? 'bg-pale-gold text-warm-gray-green border-pale-gold hover:bg-white'
                    ...
                    {activeTab === 'tour' && (
                        <div className="space-y-6 animate-fade-in">
                            ...
                            <div>
                                ...
                                <div className={`p-4 rounded-2xl mb-4 ${isDarkMode ? 'bg-white/5' : 'bg-warm-gray-green/5'}`}>
