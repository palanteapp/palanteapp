...
- Concrete situations or events they described (not just "stress at work", but the specific project, boss, conflict)
...
${transcript}`;
    ...
    try {
        ...
        if (!isAIDisabledError(e)) console.error('[Palante Memory] Failed to extract or save memories:', e);
    }
};
