...
export const AFFIRMATIONS: Quote[] = [
    // ============================================
    // GENTLE & INSPIRING (Gentle, Inspiring, creative flow)
    // ============================================
    ...
    { id: 'aff_m6', text: "Breathe in inspiration, breathe out creation.", author: "Palante", category: "Mindfulness", intensity: 1, isAffirmation: true },
    ...
    // ============================================
    // CLEAR & FOCUSED (Disciplined, Direct, Clear)
    // ============================================
    ...
    { id: 'aff_f4', text: "My time is valuable. I spend it wisely.", author: "Palante", category: "Time Management", intensity: 2, isAffirmation: true },
    ...
    { id: 'aff_f10', text: "Excellence is a habit, not an act.", author: "Palante", category: "Excellence", intensity: 2, isAffirmation: true },
    ...
    // ============================================
    // ENERGIZED & BOLD (High Energy, Resilience, Impact)
    // ============================================
    ...
    { id: 'aff_fs4', text: "Your comfort zone is where dreams go to die.", author: "Palante", category: "Growth", intensity: 3, isAffirmation: true },
    { id: 'aff_fs5', text: "Don't stop until you're proud.", author: "Palante", category: "Persistence", intensity: 3, isAffirmation: true },
    { id: 'aff_fs6', text: "Every challenge is building the strength you need for the next level.", author: "Palante", category: "Pain", intensity: 3, isAffirmation: true },
    { id: 'aff_fs7', text: "Focus on your output. Let the results speak for you.", author: "Palante", category: "Reality", intensity: 3, isAffirmation: true },
