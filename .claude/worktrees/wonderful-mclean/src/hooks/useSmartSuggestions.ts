...
export const useSmartSuggestions = (user: UserProfile | null, _isDarkMode: boolean) => {
    const suggestion = useMemo((): SmartSuggestion | null => {
        ...
        const _lastAction = user.practiceData?.lastActivityDate; // Crude proxy, ideal would be "lastActionType"
