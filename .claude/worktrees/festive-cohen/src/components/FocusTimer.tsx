                ...
                {!isFinished && (
                    <>
                        ...
                        <button
                            ...
                            className={`w-20 h-20 rounded-full flex items-center justify-center transition-all active:scale-95 shadow-xl ${isDarkMode ? 'bg-white text-sage-dark' : 'bg-sage text-white'
                                }`}
                        >
