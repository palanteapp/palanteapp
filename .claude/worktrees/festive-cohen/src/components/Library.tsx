                    ...
                    <div className="space-y-6 animate-fade-in">
                        {favoriteQuoteObjects.length === 0 ? (
                            <div className="text-center py-20">
                                ...
                                <p className={`${textSecondary} max-w-[200px] mx-auto text-center leading-relaxed`}>
                            ...
                            favoriteQuoteObjects.map((quote) => (
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between mb-6">
                                        <span className={`text-xs font-body px-4 py-2 rounded-full border ${isDarkMode ? 'bg-white/5 border-white/10 text-white/60' : 'bg-sage/10 border-sage/20 text-sage-dark/60'
                                            }`}>
                                            {quote.category}
                                        </span>
                                ...
                                >
                                    ...
                                    <div className="flex justify-between items-center mb-6">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className={`text-xs font-bold uppercase tracking-widest ${isDarkMode ? 'text-white/60' : 'text-sage-dark/60'}`}>
