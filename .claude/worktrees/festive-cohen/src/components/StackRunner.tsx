...
export const StackRunner: React.FC<StackRunnerProps> = ({
    ...
    if (!routine || !routine.steps || routine.steps.length === 0) {
        return (
            <div className={`fixed inset-0 z-[100] flex items-center justify-center p-8 ${isDarkMode ? 'bg-sage-mid text-white' : 'bg-white text-sage-dark'}`}>
    ...
    if (isFinished) {
        return (
            <div className={`fixed inset-0 z-[100] flex items-center justify-center p-6 animate-fade-in ${isDarkMode ? 'bg-sage-mid text-white' : 'bg-white text-sage-dark'}`}>
    ...
    return (
        <div className={`fixed inset-0 z-[100] flex flex-col ${isDarkMode ? 'bg-sage-mid text-white' : 'bg-white text-sage-dark'}`}>
                    ...
                    <div className="flex flex-col items-center justify-center p-8 text-center animate-fade-in min-h-[400px]">
                        ...
                        <div className="max-w-md w-full space-y-4">
                            <textarea
                                ...
                                className={`w-full p-4 rounded-xl border outline-none resize-none ${isDarkMode ? 'bg-white/5 border-white/10 text-white' : 'bg-white border-sage/20 text-sage-dark'
                                    }`}
                                rows={4}
                            />
                        </div>
