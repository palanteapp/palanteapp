                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className={`w-full pl-12 pr-4 py-4 rounded-xl outline-none transition-all border ${isDarkMode
                                            ...
                                            : 'bg-white border-sage/10 focus:border-sage text-sage-dark placeholder-sage/30'}`}
                            ...
                            <button
                                ...
                                className={`w-full py-4 rounded-xl font-display font-medium transition-all flex items-center justify-center gap-2 group ${loading
                                    ...
                                    : isDarkMode ? 'bg-pale-gold text-sage-dark hover:bg-white' : 'bg-terracotta-500 text-white hover:bg-sage-600 shadow-lg shadow-terracotta-500/20'}`}
                            >
                                {loading ? (
