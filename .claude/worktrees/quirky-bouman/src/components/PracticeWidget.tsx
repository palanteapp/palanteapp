...
export const PracticeWidget: React.FC<PracticeWidgetProps> = ({
    ...
    const getColorClasses = () => {
        if (hasPractices) {
            return {
                bg: isDarkMode
                    ? 'bg-gradient-to-br from-amber/20 to-amber-500/20'
    ...
    return (
        ...
        >
            ...
            {hasPractices && (
                <div className={`absolute inset-0 ${isDarkMode ? 'bg-gradient-to-br from-amber/10' : 'bg-gradient-to-br from-sage/10'} to-transparent animate-pulse opacity-50`} />
            )}
